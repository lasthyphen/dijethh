...
import (
	...
	"github.com/lasthyphen/dijethh/accounts/keystore"
	"github.com/lasthyphen/dijethh/accounts/scwallet"
	...
	"github.com/lasthyphen/dijethh/eth/tracers/logger"
...
func (s *PublicBlockChainAPI) GetHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (map[string]interface{}, error) {
	...
	if header != nil && err == nil {
		...
		// dijethh has no notion of a pending block
...
func (s *PublicBlockChainAPI) rpcMarshalHeader(ctx context.Context, header *types.Header) map[string]interface{} {
	...
	// Note: Dijethh enforces that the difficulty of a block is always 1, such that the total difficulty of a block
