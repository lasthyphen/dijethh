...
# Pass in DIJETHH_COMMIT as an arg to allow the build script to set this externally
ARG DIJETHH_COMMIT
ARG CURRENT_BRANCH

RUN export DIJETHH_COMMIT=$DIJETHH_COMMIT && export CURRENT_BRANCH=$CURRENT_BRANCH && ./scripts/build.sh /build/evm
